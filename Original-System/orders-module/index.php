...
<h1>Orders</h1>
    ...
    <form method="POST" action="processes/order-process.php?action=create">
            ...
            <input type="text" id="customername" class="input" name="CustomerName" placeholder="Customer's Name">
            
            <label for="ProductId">Order</label>
                <select required id="ProductId" class="select" name="ProductId">
            ...
            <input type="number" id="Quantity" name="Quantity" min="1" max="999999" placeholder="Quantity">
